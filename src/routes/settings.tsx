        ...
        <div className="mt-8 bg-blue-500/10 border border-blue-500/30 rounded-xl p-6">
          ...
          <ul className="text-gray-300 space-y-2 text-sm">
            <li className="flex gap-2">
              ...
              <span>
                <strong>BYOK (Bring Your Own Key):</strong> Your API keys are stored
            ...
            <li className="flex gap-2">
              <span className="text-cyan-400">•</span>
              <span>
                <strong>Local Models:</strong> Use Ollama or LM Studio to run models
                on your own hardware without API keys
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-cyan-400">•</span>
              <span>
                <strong>Connection Testing:</strong> Test your configuration before
                saving to ensure it works correctly
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-cyan-400">•</span>
              <span>
                <strong>Multiple Configs:</strong> Save multiple configurations and
