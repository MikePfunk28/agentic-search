 ...
 */
function getCsrfTokenFromCookies(cookieName: string = 'csrf-token'): string | null {
...
export async function csrfFetch(
  ...
  if (!token) {
    throw new Error('CSRF token not available. Ensure the server has set the csrf-token cookie.')
  }
