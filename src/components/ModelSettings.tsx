...
import { ModelProvider, ModelConfig, ProviderDefaults } from "../lib/model-config";
...
export function ModelSettings({
  ...
  const [baseUrl, setBaseUrl] = useState(
    initialConfig?.baseUrl || ProviderDefaults[ModelProvider.ANTHROPIC].baseUrl || ""
  );
  const [model, setModel] = useState(
    initialConfig?.model || ProviderDefaults[ModelProvider.ANTHROPIC].model || ""
  );
  const [temperature, setTemperature] = useState(
    initialConfig?.temperature || 0.7
  );
  const [maxTokens, setMaxTokens] = useState(
    initialConfig?.maxTokens || 4096
  );
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Model Settings</h2>
              </div>
              <button
                onClick={onClose}
