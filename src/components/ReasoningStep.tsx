        ...
        `}
			>
				...
				<button
					...
					aria-label={
						isExpanded
							? `Collapse ${step.phase} step`
							: `Expand ${step.phase} step`
					}
				...
				>
					...
					<div className="flex-shrink-0">
						...
						{step.status === "inprogress" && (
							<div
								className={`w-8 h-8 rounded-full bg-gradient-to-br ${gradient} flex items-center justify-center animate-pulse`}
							>
