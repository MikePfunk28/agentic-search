...
import { LogIn, LogOut, User, BarChart3, ChevronDown, Github } from "lucide-react";
import { useAppAuth } from "../hooks/useAppAuth";

export default function AuthButton() {
  const { user, isAuthenticated, isLoading, signIn, signOut, isAnonymous } = useAppAuth();
      ...
      <div className="relative" ref={signInRef}>
        ...
        {showSignIn && (
          <div className="absolute right-0 top-full mt-2 w-64 bg-gray-800 border border-gray-700 rounded-xl shadow-xl z-50 overflow-hidden">
            <div className="p-4">
              <h3 className="text-sm font-semibold text-white mb-3">Sign in to save your data</h3>
        ...
        {showDropdown && (
          <div className="absolute right-0 top-full mt-2 w-56 bg-gray-800 border border-gray-700 rounded-xl shadow-xl z-50 overflow-hidden">
            <div className="p-3 border-b border-gray-700 bg-amber-900/20">
              <p className="text-xs text-amber-300">Sign up to save your data permanently</p>
            </div>
            <div className="p-2">
              <button
                type="button"
